        ...
        <div class="panel-body">
           <div class="form-group">
              ...
              <div class="col-xs-10">
                  ...
                  <p class="help-block">Code name will be display on Codemanger page</p>
              </div>
           </div>
         ...
         <!--  <div class="form-group">
          ...
          <div class="form-group">
                  ...
                  <div class="well">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Insert sample data</label>
            ...
            <div class="form-group">
                <label class="control-label col-xs-2" style="text-align:right">Select key (only select one key)</label>
                <div class="col-xs-10">
                    <div class="well" style="background-color: #81BEF7">                        
                        <div class="ui-widget ui-helper-clearfix"> 
                            ...
                            <div id="fieldselected" class="ui-widget-content ui-state-default alert alert-info">
                                <h4 class="ui-widget-header alert alert-info"><span class="ui-icon ui-icon-fieldselected">fieldselected</span>Key for inverted</h4>
                            </div>
                    ...
                    <div class="well" style="display: none;">                        
                        <div class="ui-widget ui-helper-clearfix"> 
                            ...
                            <div id="fieldselected2" class="ui-widget-content ui-state-default alert alert-info">
                                <h4 class="ui-widget-header alert alert-info"><span class="ui-icon ui-icon-fieldselected2">fieldselected</span>Value field selected</h4>
                            </div>
...
function testClick(){
  ...
  //var fields = '<input type="hidden" id="changeform-codeName" class="form-control" name="ChangeForm[codeName]" value="'+obj["codeName"]+'">';
  //$("#active-form").append(fields);
  // 
   //window.location.href(<?php echo Yii::$app->urlManager->createUrl(["mapreduce/codecreated"]); ?>);
  $("#active-form" ).submit();
}
