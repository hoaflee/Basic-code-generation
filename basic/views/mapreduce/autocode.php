...
use app\models\JavaTemplate;


$patternName = Pattern::find()
            ->where(['id' => $pattern])->one();

$code = JavaTemplate::find()
    ->where(['pattern_id' => $pattern])->one();
...
<script src="<?= Yii::$app->request->baseUrl?>/js/clike.js"></script>
        ...
        <div class="well">
            <div class="row">            
                <div class="col-md-6">
                    ...
                    Change code's name here:<input type="text" class="form-control" id="codeName" value="<?= $patternName->name; ?>" name="<?= $patternName->id; ?>">
    
                    <p id="pattern" style="margin-top:10px">Design Pattern: <em class="text-primary"><?php echo($patternName->designPatterns->name).' / ';echo $patternName->name; ?></em></p>
                </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <?= $patternName->name?> Code
                    </div>
                    <div class="panel-body">
                        <textarea class=”form-control”  style ="width: 100% !important;" rows="50" id="code-reduce-python"><?= $code->code?></textarea>
                    </div>
